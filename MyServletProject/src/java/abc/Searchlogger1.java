 ...
 */
public class Searchlogger1 extends HttpServlet 
{
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            pst.setString(3,request.getParameter("memno"));
            pst.setString(4,request.getParameter("pass"));
            ResultSet rs = pst.executeQuery();
            
            if(rs.next())
            {
                out.println("Congratulations, Your data has been updated.");
